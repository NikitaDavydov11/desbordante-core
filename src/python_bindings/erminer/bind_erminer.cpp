...
void BindERMiner(pybind11::module_& main_module) {
    ...
    BindPrimitiveNoBase<AlgoERMiner>(erminer_module, "ERMiner")
            .def(pybind11::init<>())
            .def("run_algorithm",
                 pybind11::overload_cast<double, double, std::string const&, std::string const&>(
                         &AlgoERMiner::runAlgorithm),
                 pybind11::arg("min_support"), pybind11::arg("min_confidence"),
                 pybind11::arg("input_file"), pybind11::arg("output_file"))
            .def("run_algorithm",
                 pybind11::overload_cast<std::string const&, std::string const&, int, double>(
                         &AlgoERMiner::runAlgorithm),
                 pybind11::arg("input_file"), pybind11::arg("output_file"),
                 pybind11::arg("relative_minsup"), pybind11::arg("min_confidence"))
